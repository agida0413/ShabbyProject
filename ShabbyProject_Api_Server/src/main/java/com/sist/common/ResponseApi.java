...
public class ResponseApi<T> {
  ...
  //요청 실패시의 ResponseApi
    ...
    public void set405Response(HttpServletResponse response,ResponseApi<Void> responseApi,ObjectMapper objectMapper) throws JsonProcessingException, IOException {
    ...
    public void set401esponse(HttpServletResponse response,ResponseApi<Void> responseApi,ObjectMapper objectMapper) throws JsonProcessingException, IOException {
    ...
    public void set403esponse(HttpServletResponse response,ResponseApi<Void> responseApi,ObjectMapper objectMapper) throws JsonProcessingException, IOException {
    ...
    public void set410esponse(HttpServletResponse response,ResponseApi<Void> responseApi,ObjectMapper objectMapper) throws JsonProcessingException, IOException {
